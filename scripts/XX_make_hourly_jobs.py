...
for year in range(2017, 2025):
    job_script_filename = joboutdir + f'{script_to_run}___{dataset}__{year}.qsub'
    ...
    with open(job_script_filename, "w") as f3:
        ...
        f3.write('#PBS -P er8 \n')
        f3.write(f'#PBS -o /home/548/cd3022/repos/Irradiance-comparisons/logs/{script_to_run}_{dataset}_{year}.oe \n')
        f3.write('#PBS -j oe \n')
        f3.write('cd /home/548/cd3022/repos/Irradiance-comparisons \n')
        f3.write('source ./env.sh \n')
        f3.write(f'python3 scripts/{script_to_run}.py {dataset} {year}\n')
